                  ...
                  <div className="flex items-center gap-2">
                    {history.length > 0 && (
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg text-red-400 hover:bg-red-400/10 transition-colors"
                      >
