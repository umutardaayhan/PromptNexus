...
/**
 * SettingsModal Bileşeni
 * API anahtarı girişi için modal pencere
 */
const SettingsModal = ({ isOpen, onClose, apiKey, onSave }) => {
  ...
  // Modal açıldığında input'u güncelle
  useEffect(() => {
    if (isOpen) {
      setInputKey(apiKey || '');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (isValid) {
        ...
        setErrorMessage('API anahtarı geçersiz. Lütfen kontrol edin.');
      }
    } catch (error) {
      setValidationStatus('invalid');
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal Container - Ekran ortası için flexbox */}
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-neon-cyan/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-text-primary">API Ayarları</h2>
                    <p className="text-xs text-text-muted">Gemini API anahtarınızı girin</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {validationStatus === 'valid' && (
                    ...
                    >
                      API anahtarı geçerli! Kaydediliyor...
                    </motion.p>
                  )}
                  {errorMessage && (
                    <motion.p
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-text-secondary">
                        API anahtarınız tarayıcınızda yerel olarak saklanır ve sadece 
                        Gemini API&apos;ye doğrudan istek yapmak için kullanılır.
                      </p>
                      <a
